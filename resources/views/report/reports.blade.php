...
<div id="main-wrapper">
        ...
        <div class="scroll-sidebar">
            ...
            <nav class="sidebar-nav">
                <ul id="sidebarnav">
                    ...
                    <li>
                        <a href="{{url('view_reports')}}" aria-expanded="false"><i class="mdi mdi-table"></i><span class="hide-menu">Report Management</span></a>
                    </li>
                    <li>
    ...
    <div class="page-wrapper">
                                ...
                                <table id="example23" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0">
                                    ...
                                    @foreach($all_reports as $one_report)
                                        <tr>
                                            ...
                                            <td >{{$one_report->notes}}</td>
                                            <td>{{$one_report->primary_contact}}</td>
                                            <td>{{$one_report->address}}</td>
                                            <td>{{$one_report->city}}</td>
                                            <td>{{$one_report->state}}</td>
                                            <td>{{$one_report->zip}}</td>
                                            <td>{{$one_report->phone}}</td>
                                            <td>{{$one_report->additional}}</td>
                                        </tr>
                                    @endforeach
                                    </tbody>
                                </table>
        ...
        <!-- footer -->
        <!-- ============================================================== -->
        <footer class="footer"> © 2018 Land Acquisition.ORG </footer>
        <!-- ============================================================== -->
        <!-- End footer -->
        <!-- ============================================================== -->
    </div>
...
//        ]
//    });
//    var table1 = $('#example23').DataTable({
//        dom: 'Bfrtip',
//        buttons: [
//            'copy', 'csv', 'excel', 'pdf', 'print'
//        ],
...
//            }).data().each(function(group, i) {
//                if (last !== group) {
//                    $(rows).eq(i).before('<tr class="group"><td colspan="17">' + group + '</td></tr>');
//                    last = group;
//                }
//            });
//        }
