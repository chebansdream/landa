...
<head>
    ...
    <title>{{$title}}-Land Acquisition</title>
    <!-- Bootstrap Core CSS -->
                                ...
                                <li>
                                    <div class="dw-user-box">
                                        ...
                                        <div class="u-text">
                                            ...
                                            <a href="{{url('profile')}}" class="btn btn-rounded btn-danger btn-sm">View Profile</a></div>
                                    </div>
                                </li>
    ...
    <aside class="left-sidebar">
        ...
        <div class="scroll-sidebar">
            ...
            <div class="user-profile">
                <!-- User profile image -->
                <div class="profile-img"> <img src="{{asset('assets/images/avatar.png')}}" alt="user" /> </div>
                <!-- User profile text-->
                <div class="profile-text"> <a href="#" class="dropdown-toggle link u-dropdown" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="true">{{$user->name}} <span class="caret"></span></a>
            ...
            <nav class="sidebar-nav">
                <ul id="sidebarnav">
                    ...
                    <li>
                        <a class="has-arrow " href="#" aria-expanded="false"><i class="mdi mdi-package"></i><span class="hide-menu">Project Management</span></a>
                        <ul aria-expanded="false" class="collapse">
                            <li><a href="{{url('view_projects')}}">All Project</a></li>
                            @if($user->role > 0)
                            <li><a href="{{url('new_project')}}">Add New Project</a></li>
                            @endif
                        </ul>
                    </li>
                    <li>
                        <a class="has-arrow " href="#" aria-expanded="false"><i class="mdi mdi-table"></i><span class="hide-menu">Report Management</span></a>
                        <ul aria-expanded="false" class="collapse">
                            <li><a href="{{url('view_reports')}}">All Reports</a></li>
                            @if($user->role == 0)
                            <li><a href="{{url('new_report')}}">Add New Report</a></li>
                            @endif
                        </ul>
                    </li>
                    @if($user->role > 1)
                    <li>
                        <a class="has-arrow" href="#" aria-expanded="false"><i class="mdi mdi-chart-bubble"></i><span class="hide-menu">User Management</span></a>
                        <ul aria-expanded="false" class="collapse">
                            <li><a href="{{url('/all_user')}}">All Users</a></li>
                        </ul>
                    </li>
                    @endif
        ...
        <div class="sidebar-footer">
            <!-- item-->
            <a href="{{ url('profile') }}" class="link" data-toggle="tooltip" title="Profile"><i class="ti-user"></i></a>
            <!-- item-->
